...
The Jbrowse user permissions_ guide below can be found on the official Apollo read docs.

.. _permissions: https://genomearchitect.readthedocs.io/en/latest/Permissions.html

Global
~~~~~~

-  **admin**: access to everything
-  **user**: only guarantees a login with permissions configured on
   organism basis
